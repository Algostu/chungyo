'''
* Writer : get from pose-trainer
* Last updated : 2019-08-19
* About what : parse json files into numpy files
* contens : function -> main, parse_sequence, load_ps
'''
import argparse
import glob
import json
...
from pose_diff.interface.trainer.pose import Pose, Part, PoseSequence
