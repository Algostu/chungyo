...
class Momentum:
    def get_momentum(self,video_number,part,pyhsics_num):
        if video_number == 1:
            frames = np.load("/Users/dani/Desktop/Projectfile/pose-difference/data/user/IU/walk/trained_skeleton.npy")  # 풀업
        elif video_number == 2:
            frames = np.load("/Users/dani/Desktop/Projectfile/pose-difference/data/user/KSH/walk/trained_skeleton.npy")  # 풀업
